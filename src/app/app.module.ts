...
import { HostelsLandingPageComponent } from "./pages/hostels-landing-page/hostels-landing-page.component";
import { LandingBannerComponent } from "./pages/hostels-landing-page/landing-banner/landing-banner.component";
import { PhotosSectionComponent } from "./pages/hostels-landing-page/photos-section/photos-section.component";
import { FirstHostelSectionComponent } from "./pages/hostels-landing-page/first-hostel-section/first-hostel-section.component";
import { SecondHostelSectionComponent } from "./pages/hostels-landing-page/second-hostel-section/second-hostel-section.component";
import { SecondPropertyComponent } from "./pages/second-property/second-property.component";
import { BannerSecondPropertyComponent } from './pages/second-property/banner-second-property/banner-second-property.component';
import { SecondPropertyPhotosSectionOneComponent } from './pages/second-property/second-property-photos-section-one/second-property-photos-section-one.component';
import { SecondPropertyPhotosSectionTwoComponent } from './pages/second-property/second-property-photos-section-two/second-property-photos-section-two.component';

const appRoutes: Routes = [
  { path: "", component: HostelsLandingPageComponent },
  { path: "manaus", component: HomeComponent },
  { path: "figueiredo", component: SecondPropertyComponent },
...
@NgModule({
  declarations: [
    ...
    BagComponent,
    HostelsLandingPageComponent,
    LandingBannerComponent,
    PhotosSectionComponent,
    FirstHostelSectionComponent,
    SecondHostelSectionComponent,
    SecondPropertyComponent,
    BannerSecondPropertyComponent,
    SecondPropertyPhotosSectionOneComponent,
    SecondPropertyPhotosSectionTwoComponent
  ],
  imports: [
    BrowserModule,
